...
ActiveRecord::Schema.define(version: 20171007172113) do
  ...
  create_table "spaces", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_spaces_on_email", unique: true
    t.index ["reset_password_token"], name: "index_spaces_on_reset_password_token", unique: true
  end
